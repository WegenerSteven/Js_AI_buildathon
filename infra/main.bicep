...
param webapiName string = 'theaichat' //use a unique string. avoid common names like webapi, website etc.
...
//create app service and app service plan fo nikita serice
...
module theaichat 'br/public:avm/res/web/site:0.15.1' = {
  name: 'theaichat'
  scope: resourceGroup
  params: {
    kind: 'app'
...
output theaichat_URL string = theaichat.outputs.defaultHostname
